...
<div class="box-typical box-typical-padding">
	...
	<div class="tabs">
	<ul class="tab-links">
        <li class="active"><a href="#tab1">쪽지 쓰기</a></li>
	</ul>
        ...
        <div id="tab1" class="tab active">
			...
			<div id="tab2_left">
				<table class="writeForm">
					...
					<tr>
						<th>제목</th>
						<td><input type="text" class="form-control" name="msgTitle" id="msgTitle"></td>
					</tr>
					<tr>
						<th>내용</th>
						<td><textarea style="width:100%; height:300px" class="form-control" name="msgContent" id="msgContent"></textarea></td>
					</tr>
					<tr>
